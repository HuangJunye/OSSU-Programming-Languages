...
fun is_older(date1: int*int*int, date2: int*int*int) =
  ...
  then false
    ...
    then false
      (* same year and same month, compare day *)
...
(* TODO handle out of index exception *)
 ...
 * For consistency, put a comma following the day and use capitalized English month
